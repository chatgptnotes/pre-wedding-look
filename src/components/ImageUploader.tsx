        ...
        <div className="relative group w-full h-48 rounded-lg overflow-hidden">
          ...
          >
            <div className="flex space-x-2">
                <button onClick={handleUploadClick} className="flex flex-col items-center text-white font-semibold hover:text-rose-300 p-2 bg-black/20 rounded-lg" aria-label="Upload a different photo">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                    </svg>
                    <span>Upload</span>
                </button>
                <button onClick={() => setIsCameraOpen(true)} className="flex flex-col items-center text-white font-semibold hover:text-rose-300 p-2 bg-black/20 rounded-lg" aria-label="Capture a new photo with camera">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    <span>Capture</span>
                </button>
                <button onClick={onImageReset} className="flex flex-col items-center text-white font-semibold hover:text-rose-300 p-2 bg-black/20 rounded-lg" aria-label="Remove photo">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
